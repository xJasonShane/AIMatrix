  ...
  return (
    ...
    >
      <m.div
        ref={dialogRef}
        tabIndex={-1}
        className="cmdk-panel mx-auto mt-[12vh] w-[min(560px,92vw)] rounded-[14px] border border-line bg-paper-raised p-5 shadow-[0_24px_60px_-20px_rgba(20,50,42,0.4)] outline-none"
